...
Interpretation: This suggests that for the broader software industry, companies with higher ESG risk scores tended to have lower ROA, or conversely, that the most efficient companies (higher ROA) were managing their ESG risks more effectively (lower scores).
